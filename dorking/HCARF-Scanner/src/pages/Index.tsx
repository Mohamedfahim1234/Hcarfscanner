  ...
  async function handleScan() {
    ...
    if (!keys.githubToken) {
      toast({
        ...
        description: "Please enter your GitHub API key in the config panel.",
        variant: "destructive"
      });
    ...
    if (!captchaVerified || captcha !== captchaValue) {
      toast({
        ...
        description: "Please complete the CAPTCHA before scanning.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      if (findings && findings.length > 0) {
        ...
        toast({
          title: "Scan Complete",
          description: `Found ${findings.length} potential vulnerabilities.`,
          variant: "default"
        });
      } else {
        toast({
          title: "Scan Complete",
          description: "No vulnerabilities found for this domain.",
          variant: "default"
        });
      }
    } catch (err: any) {
